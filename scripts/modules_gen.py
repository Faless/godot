...
if __name__ == "__main__":
    ...
    # module tests
    module_enabled_parser = subparsers.add_parser("modules_tests", help="Generate the modules_tests file")
    module_enabled_parser.add_argument("module_db_file", type=str, help="The module db json file.")
    module_enabled_parser.add_argument("output", type=str, help="The output header file.")
    ...
    register_module_type_parser.add_argument("project_root", type=str, help="The project source root")
    ...
    if args.command == "modules_enabled":
        ...
        __make_register_module_types_cpp(args.module_db_file, args.project_root, args.output)
