...
# Load the meson_config.py for the module and obtain the information we seek for the module
...
def __create_db_file(args):
    ...
    for msp in module_search_paths:
        configs += glob.glob(os.path.join(msp, '**', 'meson_config.py'))
...
if __name__ == "__main__":
    ...
    create_db_parser.add_argument(
        '--module_search_path', type=str, nargs='+', action='append', help="The module search paths to check for meson_config.py's\n"
